...
if not args.test:
    ...
    for epoch in range(num_epochs):
        ...
        image = visualize_pred("test", pred_confidence_, pred_box_, ann_confidence_[0].numpy(), ann_box_[0].numpy(), images_[0].numpy(), boxs_default)
        
        cv2.imwrite('visualized/result_%d.jpg'%epoch, image)
        #optional: compute F1
